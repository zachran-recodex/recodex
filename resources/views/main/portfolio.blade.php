                ...
                <ul class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <li class="jos">
                        <div
                            ...
                            <!-- Thumbnail -->
                            <img src="{{ asset('') }}img/images/th-1/project-thumbnail-1.jpg"
                                alt="project-thumbnail-1" width="626" height="390"
                            ...
                            <!-- Overlay -->
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-black to-black/35 transition-all ease-in-out lg:translate-y-full lg:group-hover:translate-y-0">
                            </div>
                            <!-- Overlay -->
                        </div>
                    </li>
                    ...
                    <li class="jos">
                        <div
                            class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                            <!-- Thumbnail -->
                            <img src="{{ asset('') }}img/images/th-1/project-thumbnail-2.jpg"
                                alt="project-thumbnail-2" width="626" height="390"
                                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                            <!-- Thumbnail -->
                    ...
                    <li class="jos">
                        <div
                            class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                            <!-- Thumbnail -->
                            <img src="{{ asset('') }}img/images/th-1/project-thumbnail-3.jpg"
                                alt="project-thumbnail-3" width="626" height="390"
                                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                            <!-- Thumbnail -->
                    ...
                    <li class="jos">
                        <div
                            class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                            <!-- Thumbnail -->
                            <img src="{{ asset('') }}img/images/th-1/project-thumbnail-4.jpg"
                                alt="project-thumbnail-4" width="626" height="390"
                                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                            <!-- Thumbnail -->
                    ...
                    <li class="jos">
                        <div
                            class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                            <!-- Thumbnail -->
                            <img src="{{ asset('') }}img/images/th-1/project-thumbnail-5.jpg"
                                alt="project-thumbnail-5" width="626" height="390"
                                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                            <!-- Thumbnail -->
                    ...
                    <li class="jos">
                        <div
                            class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                            <!-- Thumbnail -->
                            <img src="{{ asset('') }}img/images/th-1/project-thumbnail-6.jpg"
                                alt="project-thumbnail-6" width="626" height="390"
                                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                            <!-- Thumbnail -->
                    ...
                    <li class="jos">
                        <div
                            class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                            <!-- Thumbnail -->
                            <img src="{{ asset('') }}img/images/th-1/project-thumbnail-7.jpg"
                                alt="project-thumbnail-7" width="626" height="390"
                                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                            <!-- Thumbnail -->
                    ...
                    <li class="jos">
                        <div
                            class="group relative overflow-hidden rounded-[25px] border-2 border-black lg:border-[5px]">
                            <!-- Thumbnail -->
                            <img src="{{ asset('') }}img/images/th-1/project-thumbnail-8.jpg"
                                alt="project-thumbnail-8" width="626" height="390"
                                class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110" />
                            <!-- Thumbnail -->
