<flux:container class="space-y-4 sm:space-y-6">
    <div class="flex flex-col space-y-4 sm:space-y-6 md:space-y-0 md:flex-row md:items-center md:justify-between">
        <div class="w-full md:w-auto">
            <flux:heading size="xl" class="font-bold! text-center md:text-left">Manage Blogs</flux:heading>
        </div>
        ...
        <div class="w-full md:w-auto">
            <flux:breadcrumbs class="justify-center md:justify-start">
                ...
                <flux:breadcrumbs.item>Manage Blogs</flux:breadcrumbs.item>
            </flux:breadcrumbs>
        </div>
    </div>
    ...
    <flux:card>
        <flux:card.header>
            <div class="flex flex-col sm:flex-row gap-4 sm:gap-0 items-center justify-between">
                <flux:heading size="lg" class="font-semibold! text-center sm:text-left">List Blogs</flux:heading>
        ...
        <flux:card.body :padding="false">
            <div class="overflow-x-auto">
                <flux:table hover striped>
                    <flux:table.columns>
                        <flux:table.column class="min-w-[250px] md:w-auto">Image</flux:table.column>
                    ...
                    <flux:table.rows>
                        @forelse ($blogs as $blog)
                            <flux:table.row>
                                ...
                                <flux:table.cell>
                                    <flux:heading class="font-semibold text-sm md:text-base">{{ $blog->title }}</flux:heading>
                                </flux:table.cell>
                        ...
                        @empty
                            <flux:table.row>
                                <flux:table.cell colspan="4" class="text-center py-6 md:py-8">
                                    ...
                                    <flux:subheading class="text-sm md:text-base">Start by creating new blog.</flux:subheading>
                                </flux:table.cell>
                            </flux:table.row>
                        @endforelse
                    </flux:table.rows>
    ...
    <flux:modal name="form" class="min-w-sm md:min-w-2xl lg:min-w-4xl">
        <div class="space-y-4 sm:space-y-6">
            <flux:heading size="lg" class="font-semibold">
                {{ $blog_id ? 'Edit Blog' : 'Add New Blog' }}
            </flux:heading>
    ...
    <flux:modal name="delete" class="min-w-[280px] sm:min-w-sm">
        <div class="space-y-4 sm:space-y-6">
            <div class="text-center sm:text-left">
                <flux:heading size="lg" class="font-semibold">Delete blog?</flux:heading>
            ...
            <div class="flex justify-end">
                <flux:button type="button" variant="danger" wire:click="deleteBlog" class="w-full sm:w-fit">
                    Delete
                </flux:button>
            </div>
        </div>
