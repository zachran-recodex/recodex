<flux:container class="space-y-4 sm:space-y-6">
    <div class="flex flex-col space-y-4 sm:space-y-6 md:space-y-0 md:flex-row md:items-center md:justify-between">
        <div class="w-full md:w-auto">
            <flux:heading size="xl" class="font-bold! text-center md:text-left">Manage Counters</flux:heading>
        </div>
        ...
        <div class="w-full md:w-auto">
            <flux:breadcrumbs class="justify-center md:justify-start">
                ...
                <flux:breadcrumbs.item>Manage Counters</flux:breadcrumbs.item>
            </flux:breadcrumbs>
        </div>
    </div>
    ...
    <flux:card>
        <flux:card.header>
            <div class="flex flex-col sm:flex-row gap-4 sm:gap-0 items-center justify-between">
                <flux:heading size="lg" class="font-semibold! text-center sm:text-left">List Counters</flux:heading>
            ...
            <div class="overflow-x-auto">
                <flux:table hover striped>
                    <flux:table.columns>
                        ...
                        <flux:table.column class="min-w-[300px] md:w-auto">Number</flux:table.column>
                    ...
                    <flux:table.rows>
                        @forelse ($counters as $counter)
                            <flux:table.row>
                                <flux:table.cell>
                                    <flux:heading class="font-semibold text-sm md:text-base">{{ $counter->title }}</flux:heading>
                                </flux:table.cell>
                        ...
                        @empty
                            <flux:table.row>
                                <flux:table.cell colspan="3" class="text-center py-6 md:py-8">
                                    ...
                                    <flux:subheading class="text-sm md:text-base">Start by creating new counter.</flux:subheading>
                                </flux:table.cell>
                            </flux:table.row>
                        @endforelse
                    </flux:table.rows>
    ...
    <flux:modal name="form" class="min-w-sm md:min-w-lg lg:min-w-xl">
        <div class="space-y-4 sm:space-y-6">
            <flux:heading size="lg" class="font-semibold">
                {{ $counter_id ? 'Edit Counter' : 'Add New Counter' }}
            </flux:heading>
    ...
    <flux:modal name="delete" class="min-w-[280px] sm:min-w-sm">
        <div class="space-y-4 sm:space-y-6">
            <div class="text-center sm:text-left">
                <flux:heading size="lg" class="font-semibold">Delete counter?</flux:heading>
            ...
            <div class="flex justify-end">
                <flux:button type="button" variant="danger" wire:click="deleteCounter" class="w-full sm:w-fit">
                    Delete
                </flux:button>
            </div>
        </div>
