...
return [
    ...
    'generators' => [
        Generators\MetaGenerator::class => [
            ...
            'description' => 'Recodex ID - Jasa pembuatan website profesional dengan teknologi terkini. Kami menyediakan layanan pengembangan web yang responsif, SEO-friendly, dan disesuaikan dengan kebutuhan bisnis Anda.',
            'keywords' => [],
